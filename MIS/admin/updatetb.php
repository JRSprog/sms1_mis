...
<body>
    ...
    margin-left: 1060px;"><br>
        ...
        <input type="text" name="detail" value="<?php echo $result['detail'];?>" required><br>

        <label>Description:</label><br>
        <textarea name="description" required><?php echo $result['description'];?></textarea><br>

        <label>Amount:</label><br>
        <input type="number" name="amount" value="<?php echo $result['amount'];?>" required><br>
   ...
   if(isset($_POST['submit'])) {
    ...
    $update = "UPDATE report SET detail='$detail',description='$description', amount='$amount',date='$date' where id='$id'";
