...
if(isset($_POST['submit']))
    {
        ...
        $stid=$_POST['stid'];
        $pass=$_POST['pass'];
        $sql="select * from stinfo where stid='$stid' and pass='$pass'";
        $sqlid = "SELECT id from `stinfo` WHERE stid = '$stid' AND pass = '$pass'";
        ...
        $stid1 = "";
           if(mysqli_num_rows($result) == 1){
	          ...
	          header("Location:student/dashboard.php?id=$stid1");
           }
...
<head>
    ...
    <link rel="shortcut icon" href="student/blogo.png" type="x-icon">
    <title>login</title>
</head>
<body>
    ...
    <div class="container1">
        <form method="post"><br>
            ...
            <h2>LOGIN</h2>
            <input type="text" name="stid" placeholder="ENTER YOUR STUDENt ID" style=" margin: 10px;
    padding: 15px;
    width: 350px;
